...
public class WatchDog {
	...
	public WatchDog() {
	      ...
	      //MsgEvent le = new MsgEvent(MsgEventType.INFO,PluginEngine.region,PluginEngine.agent,PluginEngine.plugin,"WatchDog timer set to " + PluginEngine.config.getWatchDogTimer() + " milliseconds");
		  ...
		  PluginEngine.commandExec.cmdExec(le);
	...
	class WatchDogTask extends TimerTask {
	    public void run() {
	    	...
	    	long runTime = System.currentTimeMillis() - startTS;
	    	 ...
	    	 //MsgEvent le = new MsgEvent(MsgEventType.WATCHDOG,PluginEngine.region,PluginEngine.agent,PluginEngine.plugin,"WatchDog timer set to " + PluginEngine.config.getWatchDogTimer() + " milliseconds");
